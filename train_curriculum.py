...
CURRICULUM_PHASES = [
    {
        "name": "phase_0_no_enemy_12x12_1_berry",
        "description": "12×12, no hunter, exactly 1 berry — learn pickup + exit",
    ...
    {
        "name": "phase_01_no_enemy_12x12_2_berries",
        "description": "12×12, no hunter, exactly 2 berries — learn pickup + exit",
        "total_timesteps": 500_000,
        "grid_size": 12,
        "no_enemy": True,
        "berry_count": 2,
    ...
    {
        "name": "phase_02_no_enemy_12x12_3_berries",
        "description": "12×12, no hunter, exactly 3 berries — multi-collection + exit",
    ...
    {
        "name": "phase_03_no_enemy_12x12_4_berries",
        "description": "12×12, no hunter, 4 berries",
        "total_timesteps": 300_000,
        "grid_size": 12,
        "no_enemy": True,
        "berry_count": 4,
    ...
    {
        "name": "phase_04_no_enemy_12x12_5_berries",
        "description": "12x12, no hunter, 5 berries",
        "total_timesteps": 300_000,
        "grid_size": 12,
        "no_enemy": True,
        "berry_count": 5,
    ...
    {
        "name": "phase_05_no_enemy_12x12_random_berries",
        "description": "12x12, no hunter, random berries",
        "total_timesteps": 500_000,
        "grid_size": 12,
        "no_enemy": True,
        "berry_count_min": 1,
    ...
    {
        "name": "phase_06_no_enemy_12x12_random_berries_finetune_leaving",
        "description": "12x12, no hunter, random berries",
        "total_timesteps": 300_000,
        "grid_size": 12,
        "no_enemy": True,
    ...
    {
        "name": "phase_07_with_enemy_12x12_random_berries",
        "description": "12x12, with hunter, random berries",
    ...
    {
        "name": "phase_08_with_enemy_16x16_random_berries",
    ...
    {
        "name": "phase_09_random_maps",
        "description": "Random 10×10–16×16 maps",
    ...
    {
        "name": "phase_10_hunter_avoidance_finetune",
        "description": "12x12 hunter, random berries - fine-tune with stronger danger/flee/death rewards",
        "total_timesteps": 500_000,
        "grid_size": 12,
        "no_enemy": False,
        "berry_count_min": 1,
    ...
    {
        "name": "phase_11_random_maps_hunter_avoidance_finetune",
        "description": "random maps, hunter, random berries - fine-tune with stronger danger/flee/death rewards",
        "total_timesteps": 1000_000,
        "grid_size_min": 10,
        "grid_size_max": 16,
        "no_enemy": False,
...
DEFAULT_RUN_NAME = "curriculum_v1"
...
def _print_plan(phases: list, run_root: str):
    ...
    for i, phase in enumerate(phases, start=1):
        ...
        if "berry_count" in phase:
            ...
            b_lo = phase.get("berry_count_min", 1)
